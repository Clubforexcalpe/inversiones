...
void DrawZone(Zone &zone, string name) {
   if (ObjectCreate(0, name, OBJ_RECTANGLE, 0, zone.start, zone.high)) {
      ObjectSetInteger(0, name, OBJPROP_COLOR, zone.zone_color);
      ObjectSetInteger(0, name, OBJPROP_BACK, true);
      ObjectSetDouble(0, name, OBJPROP_PRICE1, zone.high);
      ObjectSetDouble(0, name, OBJPROP_PRICE2, zone.low);
   }
}
